...
(function($PS) {
  ...
  var render = function (v) {
      return Halogen_HTML_Elements.form([ Halogen_HTML_Properties.action("/"), Halogen_HTML_Properties.method(DOM_HTML_Indexed_FormMethod.POST.value), Halogen_HTML_Properties.enctype(Data_MediaType_Common.multipartFormData) ])([ Halogen_HTML_Elements.label_([ Halogen_HTML_Core.text("ROM File to Upload: ") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputFile.value), Halogen_HTML_Properties.name("rom_file") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputSubmit.value), Halogen_HTML_Properties.value("Submit") ]) ]);
  };
